...
const SummaryDetails: React.FC<ExpenseDetailsProps> = ({
  goToNext,
  goToPrevious,
}) => {
  ...
  console.log("ECLAIM DETAILS NUMBER :::" + claimForm.claim.eclaimDetailId);
    ...
    expenseData.forEach((item) => {
      ...
      if (currency === localCurrency) {
        ...
        if (rateEntry) {
          ...
          console.warn(
            `Missing or invalid exchange rate for currency: ${currency}`
          );
        }
      }
    });
        ...
        <Container fluid className="p-3 bg-white shadow rounded">
            ...
            <CommonDataTable
              ...
              columns={[
                ...
                },
                {
                  header: "Attachment",
                  body: (rowData: CurrencyItem) => (
                    <AttachmentViewer attachments={rowData.attachments} />
                  ),
                },
              ]}
            />
          ...
          <Row className="text-center mt-4">
            <Col>
              ...
              {claimData?.eclaimApprovalStatus === "INPROGRESS" && (
                <Button className="me-2 custom-button" onClick={handleCancel}>
                  Cancel
                </Button>
              )}
              <Button
                className="me-2 custom-button"
                onClick={handleFinalSaveSummary}
              >
                Confirm & Submit
              </Button>
            </Col>
